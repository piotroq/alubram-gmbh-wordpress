# CLAUDE.md — Claude AI Configuration & Instructions

> **Dokument:** Konfiguracja i instrukcje dla Claude AI w projekcie ALUBRAM GMBH
...
2. [Konfiguracja Claude AI](#2-konfiguracja-claude-ai)
...
**Claude** to zaawansowany model AI opracowany przez Anthropic, specjalizujący się w:
...
- Optymalizacji performance i SEO

### 1.3 Dostępne Modele

| Model | Context Window | Best For |
|-------|---------------|----------|
| **Claude Sonnet 4.6** | 200k tokens | Code generation, reviews, documentation |
| **Claude Opus 4.6** | 200k tokens | Complex architecture, debugging, strategy |

---

## 2. Konfiguracja Claude AI

### 2.1 Dostęp przez Claude.ai

```
1. Zaloguj się na https://claude.ai
2. Utwórz nowy projekt "ALUBRAM GMBH WordPress"
3. Dodaj kontekst projektu (TECHNICAL-SHEETS.md, BRAND-SETTINGS.md)
4. Wybierz model: Sonnet 4.6 (domyślnie) lub Opus 4.6 (complex tasks)
```

### 2.2 Dostęp przez API
...
| Zadanie | Sonnet 4.6 | Opus 4.6 | Powód |
|---------|------------|----------|-------|
| Code generation | ✅ | ✅ | Oba dobre, Sonnet szybszy |
| Code review | ✅ | ✅ | Opus bardziej szczegółowy |
| Documentation | ✅ | ✅ | Claude lepszy styl |
| Debugging | ✅ | ✅ | Opus lepszy do complex bugs |
| Long context | ✅ | ✅ | Oba 200k tokens |
| Polish language | ✅ | ✅ | Oba dobre |
| German language | ✅ | ✅ | Oba dobre |
| Architecture decisions | ⚠️ | ✅ | Opus lepszy reasoning |
| Complex refactoring | ⚠️ | ✅ | Opus lepszy do dużych zmian |

---

*CLAUDE.md — ALUBRAM GMBH WordPress Project | v1.0.0 | 2026-02-26*
